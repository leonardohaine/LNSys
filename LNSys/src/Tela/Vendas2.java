 ...
 */
public class Vendas2 extends javax.swing.JDialog {
    ...
    public Vendas2(java.awt.Frame parent, boolean modal, String cod, String desc, Double dinheiro, int qtd) throws SQLException, ClassNotFoundException {
        super(parent, modal);
        initComponents();
    ...
    if(evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER){
        ...
        double valor =0;
            try {
                ...
                Logger.getLogger(Vendas2.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    int qtd = 0;
                    Vendas2 dialog = new Vendas2(new javax.swing.JFrame(), true, cod, desc, dinheiro, qtd);
