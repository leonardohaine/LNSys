...
//        jTableMaterial.setBackground(((row%2==0) ? Color.gray : Color.yellow));
        ...
        jTableClientes.getColumnModel().getColumn(0).setPreferredWidth(50);//0TEM
        jTableClientes.getColumnModel().getColumn(0).setMinWidth(50);
        jTableClientes.getColumnModel().getColumn(1).setPreferredWidth(130);//85 QUANT
...
//        System.out.println("COR - >"+((tableResultado.getRowCount()%2==0) ? Color.BLACK : Color.GREEN));
    ...
    public static CadClientes getInstance(Inicial instancia) throws PropertyVetoException, SQLException, ClassNotFoundException {
        if(cadclientes == null)
            cadclientes = new CadClientes(instancia);
        return cadclientes;
    }
